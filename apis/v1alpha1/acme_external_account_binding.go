...
type AcmeExternalAccountBindingSpec struct {
	...
	// name, and key. The sensitive macKey is written under the given key (defaulting to
	// macKey if unset); the keyId is written under a fixed keyId key. If namespace is
...
type AcmeExternalAccountBindingStatus struct {
	...
	//
	// Regex Pattern: `^arn:aws[a-z-]*:acm:[a-z0-9-]+:[0-9]{12}:acme-endpoint/[a-zA-Z0-9-]+/acme-external-account-binding/[a-zA-Z0-9-]+$`
	// +kubebuilder:validation:Optional
